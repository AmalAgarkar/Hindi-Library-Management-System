		...
		<div class="col-md-4" id="main_content">
			...
			<form>
				<div class="form-group">
					...
					<input type="text" class="form-control bg-light" value="<?php echo $name;?>" disabled>
				</div>
				<div class="form-group">
					<label for="admin_id">एडमिन आई डी</label>
					<input type="text" value="<?php echo $admin_id;?>" id="admin_id" class="form-control bg-light" disabled>
				</div>
				<div class="form-group">
					<label for="designation">पद</label>
					<input type="text" value="<?php echo $designation;?>" id="designation" class="form-control bg-light" disabled>
				</div>
			</form>
		</div>
	</div>
